<template>
  <div class="main-chapter1">
    ...
    <div style="margin: 10px 0; text-align: right">
      <n-link :to="{name:'journals.spec', params:{ journal: 'author', projectId: project.id, }}"><n-button>Журнал авторского надзора</n-button></n-link>
      <n-link :to="{name:'journals.spec', params:{ journal: 'tech', projectId: project.id, }}"><n-button>Журнал технического надзора</n-button></n-link>
    </div>
